...
- [x] 핵심 플로우를 선정한 이유를 사용자 목표와 최소 구매 동선 관점에서 구체적으로 작성
- [x] Figma/PowerPoint를 후가공 도구로 선택한 이유와 각 도구의 역할을 기술적으로 작성
- [x] AI 이미지 생성의 텍스트 왜곡, 오브젝트 오류, UI 구조 불일치 한계를 분석하고 재발 방지 프롬프트 전략 제시
- [x] 화면 간 일관성 유지를 위한 컴포넌트, 스타일, 오토레이아웃, 공통 React/CSS 적용 전략과 기술적 이유 작성
